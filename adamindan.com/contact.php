...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="index.html" class="nav-item nav-link active">EV</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="car.html" class="dropdown-item">Araç Listeleme</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="team.html" class="dropdown-item">Biz Kimiz</a>
                                <a href="testimonial.html" class="dropdown-item">Kullanıcı Yorumları</a>
                            </div>
                        </div>
                        <a href="contact.php" class="nav-item nav-link">Bize Ulaşın</a>
                        <a href="loginpage.php" class="nav-item nav-link">Giriş Yap</a>
                    </div>
                </div>
            </nav>
        </div>
 ...
 <div class="container-fluid py-5">
    ...
    <div class="row">
        ...
        <div class="col-6 form-group">
            <input type="text" name="email" class="form-control p-4" placeholder="Size Nasıl Ulaşalım" >
        </div>
    </div>
    <div class="form-group">
    </div>
    <div class="form-group">
        <textarea class="form-control py-3 px-4" name="mesaj" rows="5" placeholder="Mesajınızı Bırakın" required="required  " ></textarea>
    </div>
    <div>
        <button class="btn btn-primary py-3 px-5" onclick="fireSweetAlert()" type="submit" name="submit">Gönder</button>    
    </div>
...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($link, "INSERT INTO table2 (isim, email, mesaj) VALUES ('$isim', '$email', '$mesaj')");
}
